...
class BaseControl:
    ...
    def timerCmdCB(self, event):
        ...
        self.WR_send = int(self.trans_x + 2.0*self.rotat_z)
        self.WL_send = int(self.trans_x - 2.0*self.rotat_z)
        ...
        output = '(' + chr(L_forward) + chr(self.WL_send) + chr(R_forward) + chr(self.WR_send)+')'    
        #print output     
